...
class SubmitStudentAssignmentToDatabase extends StatefulWidget {
  String assignmentName;
  SubmitStudentAssignmentToDatabase({this.assignmentName});
  @override
  _SubmitStudentAssignmentToDatabaseState createState() =>
      _SubmitStudentAssignmentToDatabaseState();
}

class _SubmitStudentAssignmentToDatabaseState
    extends State<SubmitStudentAssignmentToDatabase> {
  ...
  Future selectFile() async {
    ...
    final destination = 'Assignment/' + widget.assignmentName + '/$filename';
    ...
    databaseMetheds.saveStudentAssignment(widget.assignmentName, messageMap);
    showDialog(
        context: context,
